...
return [
    ...
    'fields' => [
        ...
        'import_create_new' => 'Create new products',
        'import_delete_missing' => 'Delete missing products',
        'import_disable_missing_for_site' => 'Disable missing products in the target site',
        'import_disable_missing_globally' => 'Disable missing products globally',
        'imports' => 'Imports',
        'import_strategy_notes' => 'Import strategy notes',
        'import_update_existing' => 'Update existing products',
        'import_update_search_indexes' => 'Update search indexes',
        'is_active' => 'Active',
        ...
        'unique_identifier_field' => 'Unique identifier',
    ...
    'helpers' => [
        ...
        'feed_discovery' => 'Run Analyze source from a feed to fill these read-only examples, then choose the primary element and create draft mappings.',
        'import_create_new' => 'Adds products from the feed when no existing product matches the unique identifier.',
        'import_delete_missing' => 'Deletes products missing from the feed. Use carefully.',
        'import_disable_missing_for_site' => 'Disables missing products only in this feed target site.',
        'import_disable_missing_globally' => 'Disables missing products across all sites.',
    ...
    'placeholders' => [
        'analyze_feed_first' => 'Analyze a feed source first',
        'draft' => 'Draft',
        'never' => 'Never',
    ...
    'resources' => [
        ...
        'feed_mapping_profiles' => [
            'model_label' => 'Mapping setup',
            'plural_label' => 'Mapping setups',
            'navigation_label' => 'Mapping setups',
        ],
